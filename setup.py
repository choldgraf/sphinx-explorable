...
version = [
    line
    for line in Path("sphinx_explorable/__init__.py").read_text().split("\n")
...
setup(
    ...
    url="https://github.com/choldgraf/sphinx-explorable",
    license="MIT License",
    packages=find_packages(),
    package_data={
        "sphinx_explorable": ["_static/togglebutton.css_t", "_static/togglebutton.js"]
    },
